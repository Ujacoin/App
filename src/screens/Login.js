        ...
        <SafeAreaView style={style.containermain}>
            ...
            >
                ...
                <View style={style.loginTextInput}>
                    ...
                    ></TextInput>
                    <TouchableOpacity onPress={() => { navigation.navigate('ForgotPassword') }}><Text style={[allcommonstyle.remberboxtext, { color: COLORS.primaryyellow,textAlign:'right' }]}>Forgot password?</Text></TouchableOpacity>
                ...
                <Space spacenumber={10} />
                <PrimaryButton btntext='Sign In' backgroundColor={COLORS.primaryyellow} onPress={() => { navigation.navigate('EmailSignup') }} />
                <Space spacenumber={20} />
                <View style={style.loginheader}>
                    <Text style={style.loginheaderDesc1}>Already have an account ? -  <Text style={{ fontFamily: fontFamily.bold, color: COLORS.primaryyellow }} onPress={() => navigation.navigate("SignUp")}>Sign up</Text></Text>
