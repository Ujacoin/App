    ...
    >
      ...
      >
        ...
        <View style={globalStyle.loginheader}>
          <Text style={[globalStyle.Interbold_tnc1,{alignSelf: "center",textAlign: "center",marginTop:20}]}>Don't have an account ? - </Text>
          <Text style={[globalStyle.Interbold_tnc,{alignSelf: "center",textAlign: "center",}]} onPress={() => navigation.navigate("SignUp")}>Sign Up</Text>
        </View>
      </ScrollView>
      <Modal
        transparent
